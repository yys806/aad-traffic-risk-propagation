...
from riskprop.simulation_real_coverage import write_real_reference_package


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Freeze real-only Stage 0.5 reference features; does not run SUMO or message effects."
    )
