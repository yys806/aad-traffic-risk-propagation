...
from riskprop.e15a import write_e15a_ngsim_package  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run E15-A NGSIM calibration only; no holdout or causal-effect analysis."
    )
    ...
    package = write_e15a_ngsim_package(
