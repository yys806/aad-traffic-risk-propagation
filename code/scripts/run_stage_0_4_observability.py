...
from riskprop.communication_observability import build_stage_0_4_status_package


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Seal the current Stage 0.4 observability boundary without inferring packet loss or adoption."
    )
    ...
    output = build_stage_0_4_status_package(
