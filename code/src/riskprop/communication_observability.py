"""Evidence-bounded Stage 0.4 communication observability contracts."""
...
def profile_rv_rx_calibration(
    ...
    return {
        "schema_version": "stage_0_4.rv-rx-calibration-profile.v1",
...
def build_stage_0_4_status_package(
    *,
    ...
    audit = {
        "schema_version": "stage_0_4.communication-observability.v1",
        "experiment_id": "stage_0_4",
    ...
    provenance = {
        "schema_version": "stage_0_4.provenance.v1",
...
def _seal(output_dir: Path) -> None:
    ...
    manifest = {
        "schema_version": "stage_0_4.manifest.v1",
        "files": [
