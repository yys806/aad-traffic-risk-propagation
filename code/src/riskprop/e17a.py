"""E17-A simulation-to-real coverage gate; no message-effect analysis."""
...
def evaluate_simulation_coverage(
    *,
    ...
    return {
        "schema_version": "e17a.coverage-gate.v1",
...
def write_real_reference_package(
    *,
    ...
    audit = {
        "schema_version": "e17a.real-reference.v1",
        "experiment_id": "E17-A",
        ...
        "gate_status": "pending_pneuma_manual_and_simulation_sample",
...
def _seal_reference(output_dir: Path) -> None:
    ...
    manifest = {
        "schema_version": "e17a.real-reference-manifest.v1",
        "files": [
