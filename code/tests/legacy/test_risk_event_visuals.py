...
from riskprop.legacy.risk_event_visuals import create_risk_event_visual_package
...
def test_renderer_cli_starts_from_project_root():
    ...
    result = subprocess.run(
        [sys.executable, str(project_root / "scripts" / "legacy" / "render_risk_event_visuals.py"), "--help"],
        cwd=project_root,
        check=False,
        capture_output=True,
        text=True,
