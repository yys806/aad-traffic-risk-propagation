...
from riskprop.e15a import (
    extract_rear_end_events,
    standardize_ngsim_states,
    write_e15a_ngsim_package,
)
...
def test_e15a_package_reads_only_requested_calibration_member(tmp_path: Path) -> None:
    ...
    output = write_e15a_ngsim_package(
